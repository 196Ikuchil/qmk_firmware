// qmk_firmware % make salicylic_acid3/7skb:196key
#include "process_unicode.h"
#include QMK_KEYBOARD_H
#define UC_OSX 0  // Mac OS X
#define U_KEY_MAC  KC_RALT　// KC_LALT :unicode入力をonにする（mac側でkeyboardの設定必要）
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------+--------+--------|
      KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,        KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT, LT(_FN, KC_F16), // F16に次のソースを選択するショートかっとを設定する
  //|--------+--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------+--------+--------|
               KC_LALT, X(BOW),  KC_LGUI,  KC_SPC,         LT(_ADJUST,KC_RGUI),KC_BSPC,      X(GOOD), X(PRAY) 
          //`---------------------------------------------|   |--------------------------------------------'
  ),
